...
def discretized_mix_logistic_loss(x, l, args=None):
    ...
    x = x.contiguous()
    # if args.cuda == 1:
    # TODO: We're default to use CUDA
...
def sample_from_discretized_mix_logistic_1d(l, nr_mix):
    ...
    )  # for mean, scale #TODO: The paper has nr_mix *3
...
def parser():
    ...
    parser.add_argument("-c", "--cuda", type=int, default=1, help="Use CUDA?")
